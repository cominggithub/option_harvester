...
export function LeftNav({ specials, sectors, active, asOf, onSelect }: Props) {
  return (
    <aside className="flex h-screen w-[236px] shrink-0 flex-col border-r border-line bg-surface">
      <div className="px-4 pb-3 pt-5">
        <div className="overline text-ink-faint">Option-Premium</div>
        <h1 className="wordmark text-[22px] leading-tight text-ink">
          Option Harvester
        </h1>
      </div>

      <nav className="scrollbar-none flex-1 overflow-y-auto px-2.5 pb-4">
        <p className="px-2.5 pb-1 pt-2 text-[10px] font-semibold uppercase tracking-[0.14em] text-ink-faint">
          Screens
        </p>

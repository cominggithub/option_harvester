...
export const OH_ID_BASE = 990001; // 990001.. per computeOhWatchlists order (NC/NCcan/Cpos/Ppos/RED/HIV/HIVS/HIVSC/OTC/ROIC/LEV/LEVHIV/LEVMIX/ETFHIV/ETFMIX/ETF1X) — append only, never insert
